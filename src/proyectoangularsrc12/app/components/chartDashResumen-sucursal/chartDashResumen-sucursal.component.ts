...
@Component({
  selector: 'chartDashResumen-sucursal',
  templateUrl: './chartDashResumen-sucursal.component.html',
  styleUrls: ['./chartDashResumen-sucursal.component.css']
})
export class ChartDashResumenSucursalComponent implements OnInit, OnChanges {
  public rol: string;
  public user: User;
  ...
  traerDatos(fechaInicio, fechaFin, codsucursal) {
    this.resumenResult = [];
    this.cargado = false;
    this._dashboardService.getResumenSucursal(fechaInicio, fechaFin, codsucursal).subscribe((respuesta: any) => {
