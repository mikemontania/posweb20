...
@Component({
  ...
  selector: 'select-th-usuarios',
  templateUrl: './thusuario.component.html',
...
export class THUsuarioComponent implements OnInit {
  ...
  search = (text$: Observable<string>) =>
    text$.pipe(
      ...
      switchMap(term =>
        this._usuarioServices.traerUsuarios(0, term).pipe(
    ...
    selectedItem(item) {
     ...
     this.nombrePersona = this.cargadorUsuario.nombrePersona;
    }


    formatter = (result: Usuarios) => result.nombrePersona;
