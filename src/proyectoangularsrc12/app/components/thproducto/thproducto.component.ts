...
@Component({
  ...
  selector: 'select-th-productos',
  templateUrl: './thproducto.component.html',
...
export class THProductoComponent implements OnInit {
  ...
  search = (text$: Observable<string>) =>
    ...
    formatter = (result: Producto) => result.concatCodErpNombre;
