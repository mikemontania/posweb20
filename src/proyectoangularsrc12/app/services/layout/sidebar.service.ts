  ...
  menu: any = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { titulo: 'Listado de creditos', url: '/creditos', excluir: '!ROLE_VENDEDOR' },
...

    {
      ...
      submenu: [
        ...
        { titulo: 'Mov. Stock Premios', url: '/mvstockpremio', excluir: '!ROLE_CONTADOR ' },
        { titulo: 'Mov. Stock Premios Docs', url: '/mvstockpremiolst', excluir: '!ROLE_CONTADOR ' },
