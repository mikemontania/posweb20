// pos-cliente — zona de selección/visualización de cliente con botones de acción
// Inputs:  cliente, razonSocial, mostrar (true=muestra, false=buscador)
// Outputs: buscarClick, pedidoClick, cuponClick, influencerClick, clienteSeleccionado(cliente), buscarChange(q), cancelarBusqueda
import {
...
export class PosClienteComponent {
